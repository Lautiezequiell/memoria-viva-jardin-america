const placesData = [
  ...
  {
    id: 'place-003',
    name: 'Estadio Club Jardín América',
    category: 'deporte',
    description: 'Construcción del estadio del Club Social y Deportivo Jardín América.',
    history: 'Construcción del estadio del Club Social y Deportivo Jardín América.',
    location: { lat: -27.046, lng: -55.228 },
    address: 'Av. San Martín y Calle 25 de Mayo',
    media: {
      photos: [
        { image: 'https://lautiezequiell.github.io/memoria-viva-jardin-america/images/anio1980/estadiodeClubJardinAmerica1.jpg' },
      ],
      videos: [],
      audios: [],
    },
  ...
  },
  {
    ...
    name: 'Plaza Belgrano',
    category: 'plaza',
    description: 'Monumento a Manuel Belgrano y espacio verde familiar.',
